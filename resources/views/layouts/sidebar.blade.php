            ...
            <div class="media-left">
                <div class="avatar avatar-md avatar-circle">
                    <a href="javascript:void(0)">
                        <img class="img-responsive" src="{{ asset('assets/images/images.png') }}" alt="avatar" />
                    </a>
        ...
        <div class="menubar-scroll-inner">
            <ul class="app-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li><a href="{{ route('doctors.list') }}"><span class="menu-text">All Doctors</span></a>
                        </li>
                        <li><a href="{{ route('doctor.add') }}"><span class="menu-text">Add Doctors</span></a></li>
                ...
                <li>
                    <a href="{{ route('doctor.specialization') }}">
                        <i class="menu-icon zmdi zmdi-eye zmdi-hc-lg"></i>
                        <span class="menu-text">Specializations</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="{{ route('appointment.searchPage') }}">
                        ...
                        <span class="menu-text">Search Appointments</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('report') }}">
