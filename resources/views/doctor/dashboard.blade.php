...
<div class="row">
    <div class="row">
        ...
        <!-- New Widget for Total Doctors -->
        <div class="col-md-6 col-sm-6">
            <div class="widget stats-widget">
                <div class="widget-body clearfix">
                    <div class="pull-left">
                        <h3 class="widget-title text-info"><span class="counter"
                                data-plugin="counterUp">{{ $total_doctors }}</span></h3>
                        <small class="text-color">Total Doctors</small>
                    </div>
                    <span class="pull-right big-icon watermark"><i class="fa fa-user-md"></i></span>
                </div>
                <footer class="widget-footer bg-info">
                    <a href="{{ route('doctors.list') }}"><small> View Detail</small></a>
                    <span class="small-chart pull-right" data-plugin="sparkline"
                        data-options="[3,4,5,3,2], { type: 'bar', barColor: '#ffffff', barWidth: 5, barSpacing: 2 }"></span>
                </footer>
            </div><!-- .widget -->
        </div>
        ...
        <div class="col-md-6 col-sm-6">
            <div class="widget stats-widget">
                <div class="widget-body clearfix">
                    <div class="pull-left">
                        <h3 class="widget-title text-info"><span class="counter"
                                data-plugin="counterUp">{{ $total_specializations }}</span></h3>
                        <small class="text-color">Total Specializations</small>
                    </div>
                    <span class="pull-right big-icon watermark"><i class="fa fa-cogs"></i></span>
                </div>
                <footer class="widget-footer bg-info">
                    <a href="{{ route('doctor.specialization') }}"><small> View Detail</small></a>
                    <span class="small-chart pull-right" data-plugin="sparkline"
                        data-options="[4,2,5,3,1], { type: 'bar', barColor: '#ffffff', barWidth: 5, barSpacing: 2 }"></span>
                </footer>
            </div><!-- .widget -->
        </div>
