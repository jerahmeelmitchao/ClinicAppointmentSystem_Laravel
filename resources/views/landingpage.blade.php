    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-12">
                ...
                <div>
                    <font color="#202124" face="arial, sans-serif"><b>
                            
                                To offer every patient more than just an appointment by ensuring timely service, personalized care, and convenience. By understanding patient needs and continuously improving our processes, we aim to provide an unmatched experience in managing healthcare appointments.
            ...
            <div class="col-lg-4 col-md-5 col-12 mx-auto">
                <div class="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                    <p class="featured-text"><span class="featured-number">9999</span> Years<br> of Experiences
                    </p>
                </div>
            </div>
                ...
                <div class="booking-form">
                    ...
                    <form role="form" method="post" action="{{ route('appointment.booking') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <textarea class="form-control" rows="5" id="Message" name="Message" placeholder="Symptoms"></textarea>
                            </div>
